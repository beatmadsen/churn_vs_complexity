...
Gem::Specification.new do |spec|
  ...
  spec.description   = "Inspired by Michael Feathers' article \"Getting Empirical about Refactoring\" and the gem 'turbulence' by Chad Fowler and others. This gem was built primarily to support analysis of Java and Ruby repositories, but it can easily be extended."
  ...
  spec.metadata['changelog_uri'] = 'https://github.com/beatmadsen/churn_vs_complexity/CHANGELOG.md'
