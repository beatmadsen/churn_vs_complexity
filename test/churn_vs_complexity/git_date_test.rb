...
module ChurnVsComplexity
  class EngineTest < TLDR
    ...
    def test_git_period_with_nil_since
      period = ChurnVsComplexity::GitDate.git_period(nil, @latest_commit_date)
    ...
    def test_git_period_with_symbol_since
      period = ChurnVsComplexity::GitDate.git_period(:month, @latest_commit_date)
      assert_equal @latest_commit_date, period.end_date
    ...
    def test_git_period_with_string_since
      period = ChurnVsComplexity::GitDate.git_period('2024-01-01', @latest_commit_date)
      assert_equal @latest_commit_date, period.end_date
    ...
    def test_git_period_with_invalid_since_type
      assert_raises ChurnVsComplexity::Error do
        ChurnVsComplexity::GitDate.git_period(123, @latest_commit_date)
      end
    end

    def test_git_period_with_invalid_since_symbol_value
      assert_raises ChurnVsComplexity::Error do
        ChurnVsComplexity::GitDate.git_period(:invalid, @latest_commit_date)
      end
    end
  end
end
