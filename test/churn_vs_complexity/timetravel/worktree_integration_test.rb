  ...
  module Timetravel 
    class WorktreeIntegrationTest < TLDR
      def test_worktree_switching
        ...
        refute_equal '81845d632a4ceca8935d39a204b054f09512088e', current_sha, "Project root should not be at the checked out commit"
        ...
        assert_equal '81845d632a4ceca8935d39a204b054f09512088e', worktree_sha, "Worktree should be at the checked out commit"
      end

      def test_concurrent_worktree_switching
        git_strategy = GitStrategy.new(folder: PROJECT_ROOT_FOLDER)

        pipes = [[1664, '81845d632a4ceca8935d39a204b054f09512088e'], [1665, 'b184ad0dcfab525242b18f8de6e792be083b861c']].map do |(number, sha)|
        ...
        assert_equal ['81845d632a4ceca8935d39a204b054f09512088e', 'b184ad0dcfab525242b18f8de6e792be083b861c'].sort, shas.sort
        # check that project root is still at the latest commit
        repo = Git.open(PROJECT_ROOT_FOLDER)
        current_sha = repo.object('HEAD').sha
        refute_equal '81845d632a4ceca8935d39a204b054f09512088e', current_sha, "Project root should not be at the checked out commit"
        refute_equal 'b184ad0dcfab525242b18f8de6e792be083b861c', current_sha, "Project root should not be at the checked out commit"
      end
    end
  end
end